...
See https://github.com/AndriiAndrus/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/AndriiAndrus/goth/examples/main.go to see this in action.
*/
